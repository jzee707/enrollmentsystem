            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Student Archived List</h3>
                    <div class="box-tools">
                  ...
                  <table class="table table-hover">
                    ...
                    <td><?php echo $record->id ?></td>
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-sm btn-info" href="<?php echo base_url().'retrievestudent/'.$record->id; ?>" title="Restore"><i class="fa fa-check"></i></a>
                        </td>
                    </tr>
                    <?php
                        }
