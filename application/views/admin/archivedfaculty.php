            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Faculty Archived List</h3>
                    <div class="box-tools">

                        <form action="<?php echo base_url() ?>archivedfaculty" method="POST" id="searchList">
                ...
                <div class="modal fade" id="archive-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <form action="<?php echo base_url() ?>retreievefaculty" method="POST">
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery('ul.pagination li a').click(function (e) {
            ...
            jQuery("#searchList").attr("action", baseURL + "faculty/facultyArchivedListing/" + value);
