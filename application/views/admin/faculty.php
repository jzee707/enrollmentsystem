        ...
        <div class="row">   
            ...
            <div class="col-xs-6  text-right">
                <div class="form-group">       
                    ...
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>addNewFaculty"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
        </div>
        <div class="row">
              ...
              <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        ...
                        <form action="<?php echo base_url() ?>faculty" method="POST" id="searchList">
                  ...
                  <table class="table table-hover">
                    ...
                    <td><?php echo $record->id ?></td>
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-sm btn-info" href="<?php echo base_url().'editFaculty/'.$record->id; ?>" title="Edit"><i class="fa fa-pencil"></i></a>
                ...
                <div class="modal fade" id="archive-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <form action="<?php echo base_url() ?>archivefaculty" method="POST">
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery('ul.pagination li a').click(function (e) {
            ...
            jQuery("#searchList").attr("action", baseURL + "faculty/facultyListing/" + value);
