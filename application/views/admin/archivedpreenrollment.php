            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Pre-Enrolled Archived List</h3>
                    <div class="box-tools">

                        <form action="<?php echo base_url() ?>archivedenrollment" method="POST" id="searchList">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <td><?php echo $record->id ?></td>
                        ...
                        <a class="btn btn-sm btn-info" href="<?php echo base_url().'enrollment/restoreRequest/'.$record->id; ?>" title="Restore"><i class="fa fa-check"></i></a>
                        </td>
                    </tr>
                    <?php
                        }
