            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Pre-Registraion Student List</h3>
                    <div class="box-tools">

                        <form action="<?php echo base_url() ?>preregistration" method="POST" id="searchList">
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery('ul.pagination li a').click(function (e) {
            ...
            jQuery("#searchList").attr("action", baseURL + "student/prestudentListing/" + value);
