              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Edit Faculty Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->


                    <form role="form" id="addUser" action="<?php echo base_url() ?>editOldFaculty" method="post" role="form">
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="contactperson" name="contactperson" value="<?php echo $studentInfo->contactperson;?>" maxlength="128">
                                    </div>
                                </div>
...
$('#city').change(function(){
    ...
    $('#barangay').html('<option value="">Select Barangay</option>');
        ...
        document.getElementById("facultytype").value = "<?php echo $studentInfo->usertype ?>";
