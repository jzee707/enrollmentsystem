            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Enrolled Archived List</h3>
                    <div class="box-tools">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <td><?php echo $record->id ?></td>
                        ...
                        <a class="btn btn-sm btn-info" href="<?php echo base_url().'retreieveenrollment/'.$record->id; ?>" title="Restore"><i class="fa fa-check"></i></a>
                        </td>
                    </tr>
                    <?php
                        }
