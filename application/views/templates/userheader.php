              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <a href="<?php echo base_url(); ?>studentaccount" class="btn btn-default btn-flat"><i class="fa fa-info"></i> My Account</a>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview active">
              ...
              <li><a href="<?php echo base_url(); ?>studentdashboard"><i class="fa fa-users"></i>Dashboard</a></li>
                <li><a href="<?php echo base_url(); ?>preenrollment"><i class="fa fa-users"></i>My Schedule</a></li>
                <li><a href="<?php echo base_url(); ?>studentrecords"><i class="fa fa-users"></i>Records</a></li>
              </ul>
            </li>
