...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="<?php echo base_url(); ?>home" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0" style="color:#ffc107"></i>Western Colleges, Inc.</h2>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="<?php echo base_url(); ?>home" class="nav-item nav-link active" style="color:#ffc107">Home</a>
                <a href="<?php echo base_url(); ?>about" class="nav-item nav-link" style="color:#ffc107">About</a>
                <a href="<?php echo base_url(); ?>admission" class="nav-item nav-link" style="color:#ffc107">Admission</a>
                <a href="<?php echo base_url(); ?>academics" class="nav-item nav-link" style="color:#ffc107">Academics</a>
                <a href="<?php echo base_url(); ?>login" class="nav-item nav-link" id="mobile" style="color:#ffc107">Log In</a>
