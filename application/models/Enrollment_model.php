...
class Enrollment_model extends CI_Model {
  ...
  function deleteUser($userId, $userInfo)
    ...
    {
        $this->db->select("e.id,e.studentid,e.strandid,e.type,sd.sectionid,sc.section,e.status,sc.gradelevel,e.term,sy.schoolyear,concat(s.firstname, ' ',s.lastname) as student,st.strandcode");
